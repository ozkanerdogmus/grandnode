        ...
        if (selected != null) {
            ...
            for (i = 0; i < Reservation.availableDates.length; i++) {
                ...
                if (selectedYear == year && selectedMonth == month && selectedDay == day) {
                    $("#hoursDiv").append("<label class='btn btn-outline-secondary'><input type='radio' id='Reservation_" + Reservation.availableDates[i].Id + "' name='Reservation' value='" + Reservation.availableDates[i].Id + "' /><span class='btn-bg'></span>" + Reservation.availableDates[i].Date.substring(11, 16) + "</div>");
                }
            }
